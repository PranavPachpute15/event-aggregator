...
const SkeletonCard = () => ( <div className="animate-pulse bg-white/10 p-5 rounded-xl"> <div className="h-4 bg-white/20 mb-3 w-3/4"></div> <div className="h-3 bg-white/20 mb-2"></div> <div className="h-3 bg-white/20 w-1/2"></div> </div>
);

return ( <div className="flex min-h-screen bg-gradient-to-br from-black via-gray-900 to-gray-800 text-white">
...
```
  ...
  <div className="flex-1 ml-64">
    ...
    <div className="fixed top-0 left-64 right-0 bg-black/40 backdrop-blur-xl border-b border-white/10 p-4 flex justify-between items-center z-50">
      <h1 className="text-2xl font-bold">STUDENT EVENT AGGREGATOR</h1>
      ...
      <div className="flex gap-3">
        ...
        <select
          ...
          className="px-3 py-2 rounded-lg bg-gray-900 border border-white/20"
        >
